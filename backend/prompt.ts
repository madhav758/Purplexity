export const SYSTEM_PROMPT = `You are an expert assistant called purplexity. Your job is simple, given the USER_QUERY and 
...
<FOLLOW_UPS>
    ...
    <question>Which is better: rust or typescript?</question>
</FOLLOW_UPS>
`
